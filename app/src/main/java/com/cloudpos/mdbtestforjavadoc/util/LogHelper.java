...
import com.cloudpos.mdbtestforjavadoc.BuildConfig;
...
public class LogHelper {
     ...
     *
     * @param text
     * @param infoMsg   infoMsg : color is red < color name="red">#FF0000< /color><
     *                 !--红色 -->
     */
    @Deprecated
    ...
    /**
     * @param text text
     * @param infoMsg   infoMsg : color is black
     */
    @Deprecated
    ...
    /**
     * @param text text
     * @param infoMsg   infoMsg : color is yellow
     */
    @Deprecated
    ...
    public static void appendBlueMsg(String msg, TextView txtResult) {
        SpannableString msgToDisplay = new SpannableString(msg + "\n");
    ...
    public static void massiveLog(char c, String tag, String log){
        boolean MASSIVE_LOG = BuildConfig.IS_DEBUG_MODE;
        if(MASSIVE_LOG){
            switch (c) {
                case 'd':
                    Log.d(tag, log);
